...
All keyboard shortcuts can be customized via `~/.weavra/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.weavra/agent/keybindings.json`:
