...
[`AgentSessionEvent`](https://github.com/kjg8619/Weavra/blob/main/runtime/pi/packages/coding-agent/src/core/agent-session.ts)
...
[`AgentEvent`](https://github.com/kjg8619/Weavra/blob/main/runtime/pi/packages/agent/src/types.ts):
...
Base messages from [`packages/ai/src/types.ts`](https://github.com/kjg8619/Weavra/blob/main/runtime/pi/packages/ai/src/types.ts#L134):
- `UserMessage` (line 134)
- `AssistantMessage` (line 140)
- `ToolResultMessage` (line 152)

Extended messages from [`packages/coding-agent/src/core/messages.ts`](https://github.com/kjg8619/Weavra/blob/main/runtime/pi/packages/coding-agent/src/core/messages.ts#L29):
...
```bash
weavra --mode json "List files" 2>/dev/null | jq -c 'select(.type == "message_end")'
```
