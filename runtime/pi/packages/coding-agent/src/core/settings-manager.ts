...
export interface Settings {
	lastChangelogVersion?: string; // Historical imported setting; no product release checks.
	...
	collapseChangelog?: boolean; // Historical imported setting; no automatic changelog.
	enableInstallTelemetry?: boolean; // Provider attribution preference; never enables hosted analytics.
	enableAnalytics?: boolean; // Historical imported setting; no analytics transport.
	trackingId?: string; // Historical imported value; never generated or transmitted.
