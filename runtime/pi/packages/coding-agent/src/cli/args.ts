...
import { APP_NAME, ENV_AGENT_DIR, ENV_SESSION_DIR } from "../config.ts";
...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update <source|--extensions|--models>  Update extensions or configured model catalogs
...
${chalk.bold("Options:")}
  ...
  --version, -v                  Show product identity and development version
...
${chalk.bold("Environment Variables:")}
  ...
  ${ENV_AGENT_DIR.padEnd(32)} - Config directory (default: <WEAVRA_HOME or ~/.weavra>/agent)
  ${ENV_SESSION_DIR.padEnd(32)} - Session storage directory (overridden by --session-dir)
  WEAVRA_PACKAGE_DIR               - Override package directory (for Nix/Guix store paths)
  PI_OFFLINE                       - Disable startup network operations when set to 1/true/yes
  PI_TELEMETRY                     - Control attribution on explicit provider requests; never enables analytics
