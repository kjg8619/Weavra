...
import { APP_NAME, APP_TITLE, ENV_AGENT_DIR, ENV_SESSION_DIR } from "../config.ts";
...
${chalk.bold("Commands:")}
  ${APP_NAME} setup                     Prepare private Weavra user state
  ${APP_NAME} doctor                    Diagnose local Weavra installation
  ${APP_NAME} install <source> [-l]     Install extension source and add to settings
  ${APP_NAME} remove <source> [-l]      Remove extension source from settings
  ${APP_NAME} uninstall <source> [-l]   Alias for remove
  ${APP_NAME} update [source|self]      Show source update policy or update extensions
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as WEAVRA_OFFLINE=1)
...
${chalk.bold("Examples:")}
  ...
  ${APP_NAME} --export ~/.weavra/agent/sessions/--path--/session.jsonl
...
${chalk.bold("Environment Variables:")}
  ...
  WEAVRA_HOME                     - Product home (default: ~/.weavra)
  ${ENV_AGENT_DIR.padEnd(32)} - Config directory (default: ~/.weavra/agent)
  ${ENV_SESSION_DIR.padEnd(32)} - Session storage directory (overridden by --session-dir)
  WEAVRA_PACKAGE_DIR               - Override internal package directory (Nix/Guix)
  WEAVRA_OFFLINE                  - Disable startup network operations (1/true/yes)
  WEAVRA_TELEMETRY                - Provider attribution preference; no product analytics transport
