...
export const PRODUCT_VERSION = "development";
export const CONFIG_DIR_NAME = ".pi";
export const VERSION: string = pkg.version || "0.0.0";

// Canonical product overrides; inherited Pi homes are never selected implicitly.
...
/** Get the agent config directory (e.g., ~/.weavra/agent/) */
