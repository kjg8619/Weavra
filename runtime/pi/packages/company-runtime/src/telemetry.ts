	...
	spans: {
		...
		"weavra.worker": {
			...
			startAttributes: {
				...
				profile: {
					type: "string",
					description: "Routed model profile",
					required: true,
					values: ["coding", "reasoning", "fast", "creative"],
				},
				modelIntent: {
					type: "string",
					description: "Configured model intent alias that selected the profile",
					required: false,
					values: ["simple", "standard", "review", "deep"],
				},
