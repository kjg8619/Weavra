...
> = {
  ...
  create_threads: ["Create", "Creating", "Created", "Weavra threads"],
  t3_thread_start: ["Start", "Starting", "Started", "a Weavra thread"],
  t3_thread_list: ["List", "Listing", "Listed", "Weavra threads"],
  t3_thread_read: ["Read", "Reading", "Read", "a Weavra thread"],
  t3_thread_send: ["Send", "Sending", "Sent", "to a Weavra thread"],
  t3_thread_wait: ["Wait", "Waiting", "Waited", "for a Weavra thread"],
  t3_thread_interrupt: ["Interrupt", "Interrupting", "Interrupted", "a Weavra thread"],
