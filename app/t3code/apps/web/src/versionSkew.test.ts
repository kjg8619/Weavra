...
describe("versionSkew", () => {
  ...
  it("refuses inherited desktop-managed update capabilities", () => {
    expect(
      resolveServerSelfUpdateCapability({
        environment: {
  ...
  it("never advertises remote desktop update support", () => {
    ...
    expect(supportsDesktopAppUpdate(descriptor(true))).toBe(false);
