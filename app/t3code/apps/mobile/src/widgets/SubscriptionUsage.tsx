...
function SubscriptionUsage(
  ...
  const providers = props.providers ?? [
    { name: "Codex", detail: "Open Weavra to connect", windows: [], expiresAt: 0 },
    { name: "Claude", detail: "Open Weavra to connect", windows: [], expiresAt: 0 },
  ];
