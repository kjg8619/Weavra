...
function confirmDeregister(environment: RelayClientEnvironmentRecord, onConfirm: () => void) {
  ...
  const message = `“${environment.label}” will be removed from this account. Remote access access will be revoked, any managed tunnel will be removed, and a host space will become available. Local connections on your devices are not changed.`;
  ...
  return (
    ...
    >
      ...
      {environmentsState.error ? (
        <>
          <ClerkRow
            title="Could not load Remote access environments"
        ...
        <ClerkRow
          ...
          subtitle="Link a server from its local Settings to reach it through Remote access."
        />
      )}
