...
export class DesktopAppUnreachableError extends Schema.TaggedError<DesktopAppUnreachableError>()(
  ...
  override get message(): string {
    return "Could not reach the Weavra desktop app. Start or update the desktop app on this machine, then run `t3 app` again. A running Weavra server is not enough.";
  }
}
