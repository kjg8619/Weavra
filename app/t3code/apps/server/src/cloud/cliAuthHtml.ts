...
<html lang="en">
  <head>
    ...
    <title>Remote access authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Remote access. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
